/**
 * @description Non-Public methods called by tests
 * @kind problem
 * @id javascript/non-public-method-called-via-test
...
exists(MethodDefinition md | not md.isPublic() and md.getBody() = f)
}
